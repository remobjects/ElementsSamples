...
Public Module Program
  ...
  Shared Function Main(args As String()) As Int32
	...
	windowClass.style = CS_HREDRAW OrElse CS_VREDRAW
	...
	'  Create the Window
	'
	Dim window = CreateWindowExW(0, szWindowClass, szTitle, WS_OVERLAPPED OrElse WS_CAPTION OrElse WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, 400, 300, Null, Null, windowClass.hInstance, Null)
	...
	'  Add a button to it
	'
	button = CreateWindowEx(0, "BUTTON", "Click Me", WS_TABSTOP OrElse WS_VISIBLE OrElse WS_CHILD OrElse BS_DEFPUSHBUTTON, 130, 70, 100, 25, window, Null, windowClass.hInstance, Null)
	'  Pointer not needed.
	'
	'  Show the Window
	'
