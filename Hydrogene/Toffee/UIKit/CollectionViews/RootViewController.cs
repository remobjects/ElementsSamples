namespace CollectionViews
{
	...
	{
		private const string CELL_IDENTIFIER = "RootViewController_Cell";
		private const string HEADER_IDENTIFIER = "RootViewController_Header";
	
		private NSArray data;
		
		private UICollectionViewFlowLayout collectionViewFlowLayout { get { return collectionView.collectionViewLayout as UICollectionViewFlowLayout; } }


		public override id init()
		{
			this = base.initWithCollectionViewLayout(new UICollectionViewFlowLayout());
			if (this != null)
			{
		...
		public UICollectionViewCell collectionView(UICollectionView collectionView) cellForItemAtIndexPath(NSIndexPath indexPath)
		{
			...
			result.subviews.makeObjectsPerformSelector(__selector(removeFromSuperview));
