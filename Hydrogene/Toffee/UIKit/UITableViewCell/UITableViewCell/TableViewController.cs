namespace CSharpiOSTableViewCellDemo
{
    ...
    private string [][] dataArray;
		...
		public override id init()
		{
			...
			if (this != null)
			{
				title = "CSharp UITableViewCell Demo";


    dataArray = new string[][] {{"Athens","Greece","Summer","1896","April 6 to April 15"},
		...
		{
			base.viewDidLoad();
			this.tableView.registerNib(UINib.nibWithNibName("OlympicCityTableViewCell") bundle(NSBundle.mainBundle)) forCellReuseIdentifier("OlympicCityCell");
		}
    ...
    {
         OlympicCityTableViewCell cell= tableView.dequeueReusableCellWithIdentifier("OlympicCityCell"); 
    ...
    {
         OlympicCityTableViewCell cell = (OlympicCityTableViewCell)tableView.cellForRowAtIndexPath(indexPath);
         UIAlertView message = new UIAlertView withTitle("City Selected") message(cell.city.text) @delegate(null) cancelButtonTitle("OK") otherButtonTitles(null);
         message.show();
	 }

    private CGFloat tableView(UITableView tableView) heightForRowAtIndexPath(NSIndexPath indexPath)
    {
     return 149;
	  }
