...
type
  ...
  CachedCalculationsAttribute = public class(Attribute, RemObjects.Elements.Cirrus.IMethodImplementationDecorator, RemObjects.Elements.Cirrus.ITypeInterfaceDecorator)
  private
...
var lCache := unquote<System.Collections.Hashtable>(new RemObjects.Elements.Cirrus.Values.FieldValue(new RemObjects.Elements.Cirrus.Values.SelfValue(), aMethod.Owner.GetField('fCache')));
      ...
      try
        Aspects.OriginalBody;
        var res := Aspects.RequireResult<Int64>;
        lMethodResult := Int64(res);
      finally
...
method CachedCalculationsAttribute.HandleInterface(Services: IServices; aType: ITypeDefinition);
begin
